...
public class DanhsachcacplaylistAdapter extends RecyclerView.Adapter<DanhsachcacplaylistAdapter.ViewHolder> {
    ...
    Context context;
    ArrayList<Playlist> mangplaylisrt;

    public DanhsachcacplaylistAdapter(Context context, ArrayList<Playlist> mangplaylisrt) {
        this.context = context;
        this.mangplaylisrt = mangplaylisrt;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Playlist playlist=mangplaylisrt.get(position);
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("itemplaylist",mangplaylisrt.get(getPosition()));
